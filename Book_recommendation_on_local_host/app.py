...
def main():
    ...
    if choice == "About us":
        ...
        book_list = pickle.load(open('df_final_small.pkl', 'rb'))
        book_pics = pickle.load(open('df_final_small.pkl', 'rb'))
        csr_matrix = pickle.load(open('condensed_matrix_small.pkl', 'rb'))
        sparse_matrix = pickle.load(open('small_sparsed_matrix.pkl', 'rb'))
